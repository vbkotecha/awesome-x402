...
- [AIServices](https://aiservices.to) — Data APIs for AI agents: crypto prices (free), technical indicators ($0.02), DeFi yields ($0.02), fear-greed index (free), IP geolocation (free), URL metadata ($0.01), and AI dispute resolution ($0.05). USDC micropayments on Base mainnet via x402. MCP server included. No API keys, no signup. ([API](https://api.aiservices.to) | [OpenAPI](https://api.aiservices.to/docs) | [GitHub](https://github.com/vbkotecha/aiservices-api))
