...
- [AgentCourt](https://api.agentcourt.to) — Policy-driven dispute resolution API for agent commerce. Submit disputes for AI-driven rulings with 7 policy templates (milestone payment, freelance delivery, bug bounty, SLA, API quality, physical commerce, scope disputes). $0.05 USDC/dispute on Base mainnet. Free policy browsing and case tracking. x402 v2 with CDP Facilitator + Bazaar discovery. ([GitHub](https://github.com/vbkotecha/agentcourt-api) | [x402 manifest](https://api.agentcourt.to/.well-known/x402))
- [AIServices](https://api.aiservices.to) — Paid data APIs for AI agents on Base mainnet: crypto technical indicators (RSI, Bollinger Bands, ATR) at $0.02, DeFi yield pools by TVL at $0.02, URL metadata extraction at $0.01. Free tier: crypto prices, Fear & Greed index, IP geolocation. x402 v2 with CDP Facilitator + Bazaar discovery. ([GitHub](https://github.com/vbkotecha/aiservices-api) | [x402 manifest](https://api.aiservices.to/.well-known/x402))
